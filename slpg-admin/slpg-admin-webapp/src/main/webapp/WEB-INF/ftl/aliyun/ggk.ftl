...
<script>
    ...
    var NC_Opt = {
        ...
        elements: [
            'http://static.cartoonai.com/assets/img/ggk.png',
            'http://static.cartoonai.com/assets/img/ggk.png'
        ],
        ...
        upLang: {
            "cn": {
                _ggk_guide: "请在屏幕上滑动，刮出两枚狮子",
                _ggk_success: "恭喜您成功刮出狮子<br/>继续下一步操作吧",
                _ggk_loading: "正在加载中",
                _ggk_fail: ['呀，狮子不见了<br/>请', "javascript:NoCaptcha.reset()", '再来一次', '或', "http://survey.taobao.com/survey/QgzQDdDd?token=%TOKEN", '反馈问题'],
        ...
        callback: function (data) { //成功回调
            ...
            location.href = '/ggk/valid?sessionid=' + data.sessionId + '&sig=' + data.sig + '&token=' + nc_token + '&scene=' + nc_scene + '&callurl=' + callurl;
        },
